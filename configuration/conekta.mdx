---
title: "Configure Conekta Payment Gateway for Each Company"
sidebarTitle: "Conekta"
description: "Set up per-company Conekta API keys to enable credit and debit card payment processing on MikroTik Hotspot captive portals in Mexico."
---
