---
title: "Super Admin: Router and API Key Management Endpoints"
sidebarTitle: "Routers"
description: "Super admin endpoints to create routers for tenant companies, generate and rotate JWT API Keys, revoke compromised keys, and monitor key expiry and usage."
---
