...
description: "Returns active WiFi access plans for the router sorted by visual order and featured flag, with price, MikroTik profile name, and JSON detail bullets."
---
