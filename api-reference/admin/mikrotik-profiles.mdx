---
title: "MikroTik Hotspot Profile Endpoints"
sidebarTitle: "MikroTik Profiles"
description: "Retrieve real Hotspot profiles from a connected MikroTik router and test the API connection. Used to map profiles to products."
---
