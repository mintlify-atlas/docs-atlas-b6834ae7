---
title: "Get Started with Pagos Hotspot API in 5 Minutes"
sidebarTitle: "Quickstart"
description: "Send your first payment request and receive MikroTik Hotspot credentials in under 5 minutes using curl or the API sandbox."
---
